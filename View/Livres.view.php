...
<table class="table table-hover">
 ...
 <?php for ($i=0; $i <count($tab) ; $i++) { ?>
      ...
      <td class="align-middle"> <a href="<?= URL?>livres/l/<?=$tab[$i]->getId()?>"><?php echo $tab[$i]->getTitre(); ?></a></td>
      <td class="align-middle"><?php echo $tab[$i]->getNbpage(); ?></td>
      <td class="align-middle"><a href="<?=  URL ?>livres/m/<?=$tab[$i]->getId()?>"><button type="button" class="btn btn-primary">Modifier</button></a></td>
      <td class="align-middle"><a href="<?=  URL ?>livres/s/<?=$tab[$i]->getId()?>"><button type="button" class="btn btn-warning">Supprimer</button></a></td>
    </tr> 
    <?php };?>
  </table>
